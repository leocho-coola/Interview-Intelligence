        ...
        <div className="bg-white p-10 rounded-[32px] shadow-2xl shadow-indigo-100/50 border border-slate-100 transition-all hover:border-indigo-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative flex items-center justify-center my-6">
              ...
              <span className="bg-white px-4 text-xs font-bold text-slate-400 absolute">또는</span>
            </div>

            <button 
              type="button"
              onClick={handleGoogleLogin}
              className="w-full bg-white hover:bg-slate-50 text-slate-900 font-bold py-5 px-6 rounded-2xl transition-all border-2 border-slate-200 hover:border-indigo-300 flex items-center justify-center gap-3 group shadow-lg"
            >
